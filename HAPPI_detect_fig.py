...
#********************************************************
def DrawMap_dotshade(a2in, a2dot, a1lat, a1lon, BBox=[[-90., 0.],[90., 360.]], bnd=False, vmin=False, vmax=False, cmap="Spectral",figname="./temp.png",stitle=False, parallels=arange(-90,90+0.1, 30), meridians=arange(-180,360+0.1,30) ,maskcolor=False, dotcolor="k", dotstep=1, markersize=3, miss=-9999.):
  # Lat, Lon ------
  a1lat = array( a1lat )
  a1lon = array( a1lon )
